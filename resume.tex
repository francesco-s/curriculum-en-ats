...
\titlespacing*{\section}{0pt}{10pt plus 2pt minus 1pt}{6pt plus 2pt minus 1pt}

% (Optional) If you ever add \subsection, keep spacing consistent:
...
\setlist[itemize]{nosep, topsep=5pt, partopsep=0pt, parsep=0pt, leftmargin=*, labelsep=0.45em}
\linespread{1}
\setlength{\emergencystretch}{2em}

% Icon separator for contact line
\newcommand{\iconsep}{\ {\color{darkblue}\faCircle}\ }
